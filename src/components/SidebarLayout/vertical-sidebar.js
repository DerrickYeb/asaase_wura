...
import { AddTenant, AllTenantList, Dashboard, EditInvoicePayment, RecurringInvoicePayment, RegisterLand, SellLand, SendPaymentRequestInvoice, ViewInvoicePayments, ViewLands, ViewPayments } from '../../route/routes';
       ...
       <>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <li className="nav-item">
                    <Link className={`${location.pathname === Dashboard ? 'active' : ''} nav-link `} aria-current="page" href={Dashboard} onClick={() => {}}>
                        <i className="icon">
                ...
                <CustomToggle eventKey="sidebar-special" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name">Lands</span>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        ...
                        <li className="nav-item">
                                <Link className={`${location.pathname === ViewLands ? 'active' : ''} nav-link`} href={ViewLands}>
                                    <i className="icon">
                                    ...
                                    <i className="sidenav-mini-icon"> All </i>
                                    <span className="item-name">All</span>
                                </Link>
                            </li>   
                        <li className="nav-item">
                                <Link className={`${location.pathname === RegisterLand ? 'active' : ''} nav-link`} href={RegisterLand}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Add Land</span>
                                </Link>
                            </li>   
                            <li className="nav-item">
                                <Link className={`${location.pathname === SellLand ? 'active' : ''} nav-link`} href={SellLand}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i className="sidenav-mini-icon"> Sell </i>
                                    <span className="item-name">Sell Land</span>
                                </Link>
                            </li>                            
                        </ul>
                    </Accordion.Collapse>
                ...
                <Accordion.Item as="li" className={`${activeMenu === '0' ? 'active' : ''}`} eventKey="sidebar-auth"  bsPrefix="nav-item">
                    ...
                    <Accordion.Collapse eventKey="sidebar-auth">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === ViewInvoicePayments ? 'active' : ''} nav-link`} href={ViewInvoicePayments}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === RecurringInvoicePayment ? 'active' : '' } nav-link`} href={RecurringInvoicePayment}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Recurring Bill</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === EditInvoicePayment ? 'active' : ''} nav-link`} href={EditInvoicePayment}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            {/* <li className="nav-item">
                                <Link className={`${location.pathname === '/auth/lock-screen' ? 'active' : ''} nav-link`} href="/auth/lock-screen">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            {/* <li className="nav-item">
                                <Link className={`${location.pathname === '/auth/recoverpw' ? 'active' : ''} nav-link`} href="/auth/recoverpw">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix="nav-item">
                    <CustomToggle eventKey="sidebar-user" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name">Tenants</span>
                        <i className="right-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === AllTenantList ? 'active' : ''} nav-link`} href={AllTenantList}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Tenants List</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === AddTenant ? 'active' : ''} nav-link`} href={AddTenant}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Add Tenant</span>
                                </Link>
                            </li>
                            {/* <li className="nav-item">
                                <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} href="/dashboard/app/user-list">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="utilities-error" bsPrefix="nav-item">
                    ...
                    <Accordion.Collapse eventKey="utilities-error">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === ViewPayments ? 'active' : ''} nav-link`} href={ViewPayments}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === SendPaymentRequestInvoice ? 'active' : ''} nav-link`} href={SendPaymentRequestInvoice}>
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Payment Request</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/errors/maintenance' ? 'active' : ''} nav-link`} href="/errors/maintenance">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <li className="nav-item">
                <Link className={`${location.pathname === '/dashboard/admin/admin' ? 'active' : ''} nav-link`} href="/dashboard/admin/admin">
                        <i className="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name">Surveyors</span>
                    </Link>
                </li>
            </Accordion>
       </>
